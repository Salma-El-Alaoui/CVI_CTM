import os
import numpy as np
from src.variational_bayes_ctm.corpus import NewsDataset
...
filename = 'conv_stoch_cvi_B=%d_OF=%d_D=%d_S=%d.txt' % (
batch_size, learning_offset, learning_decay * 10, step_size * 10)
