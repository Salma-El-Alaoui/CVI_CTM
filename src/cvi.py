...
=======================================================================
This implementation is modified from Chyi-Kwei Yau's LDA code
Link: https://github.com/scikit-learn/scikit-learn/blob/ab93d65/sklearn/decomposition/online_lda.py#L137
"""
# Author: Salma El Alaoui Talibi
...
def _update_doc_distribution(X, exp_topic_word_distr, doc_topic_prior, doc_topic_prior_gauss,
    ...
    exp_topic_word_distr : dense matrix, shape=(n_topics, n_features)
        ...
        This is `exp(E[log(beta)])`.
    doc_topic_prior : float
        Prior of document topic distribution `eta` for CTM and 'theta' otherwise.
    max_iters : int
    ...
    (doc_topic_distr, suff_stats) :
        ...
        this is `gamma` when it's a an LDA model. 
...
class CVI(BaseEstimator, TransformerMixin):
    ...
    def _e_step(self, X, cal_sstats, random_init, parallel=None):
        ...
        (doc_topic_distr, suff_stats) :
            ...
            document. This is `gamma` for an LDA model.
            `suff_stats` is expected sufficient statistics for the M-step.
